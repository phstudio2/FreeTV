...
class CountryActivity : AppCompatActivity() {
    ...
    private fun internet(): Boolean {
        val connectivityManager =
            this@CountryActivity.getSystemService(Context.CONNECTIVITY_SERVICE) as ConnectivityManager
            ...
            ItemAdapter2(
                ...
                object : ItemAdapter2.OnItemClickListener {
                    override fun onItemClick(position: Int) {
                        val (_, _, stringList2) = splitList(countryList)
                        val url = stringList2[position]
                        if (url.contains("https://www.youtube.com")) {
                            val intent = Intent(this@CountryActivity, HTMLActivity::class.java)
                            intent.putExtra("Name", url)
                            startActivity(intent)
                        } else {
                            val intent = Intent(this@CountryActivity, PlayerActivity::class.java)
                            intent.putExtra("Name", url)
                            startActivity(intent)
                        }
        ...
        if (internet()) {
            Thread {
                try {
                    ...
                    val countryToAdd = ArrayList<Triple<String, String, String>>()
                    ...
                    runOnUiThread {
                        countryList.addAll(countryToAdd)
    ...
    private fun splitList(countryList: ArrayList<Triple<String, String, String>>): Triple<ArrayList<String>, ArrayList<String>, ArrayList<String>> {
    ...
    private val countryList = ArrayList<Triple<String, String, String>>()
