...
class Argentina : AppCompatActivity() {
    ...
    private fun internet(): Boolean {
        val connectivityManager =
            this@Argentina.getSystemService(Context.CONNECTIVITY_SERVICE) as ConnectivityManager
    ...
    private fun getPublic() {
        if (internet()) {
            Thread {
                try {
                    val website =
                        URL("https://raw.githubusercontent.com/Free-TV/IPTV/master/playlists/playlist_argentina.m3u8")
                    ...
                    val argentinaToAdd = ArrayList<Triple<String, String, String>>()
                    ...
                    runOnUiThread {
                        argentinaList.addAll(argentinaToAdd)
    ...
    private fun splitList(argentinaList: ArrayList<Triple<String, String, String>>): Triple<ArrayList<String>, ArrayList<String>, ArrayList<String>> {
    ...
    private val argentinaList = ArrayList<Triple<String, String, String>>()
