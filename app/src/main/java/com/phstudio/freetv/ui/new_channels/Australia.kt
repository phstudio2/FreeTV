...
class Australia : AppCompatActivity() {
    ...
    private fun internet(): Boolean {
        val connectivityManager =
            this@Australia.getSystemService(Context.CONNECTIVITY_SERVICE) as ConnectivityManager
        ...
        if (internet()) {
            Thread {
                try {
                    ...
                    val australiaToAdd = ArrayList<Triple<String, String, String>>()
                    ...
                    runOnUiThread {
                        australiaList.addAll(australiaToAdd)
    ...
    private fun splitList(australiaList: ArrayList<Triple<String, String, String>>): Triple<ArrayList<String>, ArrayList<String>, ArrayList<String>> {
    ...
    private val australiaList = ArrayList<Triple<String, String, String>>()
